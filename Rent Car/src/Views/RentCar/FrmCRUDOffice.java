...
public class FrmCRUDOffice extends javax.swing.JFrame {
    ...
    //Method to register
    private void registerNewOffice() {
        try {
            OfficeBO obo = new OfficeBO();
            Office o = new Office();
            o.setOffice_id(txtIDoffice.getText());
            o.setOffice_name(txtNameOffice.getText());

                if (obo.register(o)) {
                    JOptionPane.showMessageDialog(null, "Office registered");
                }
                clear();
    ...
    private void initComponents() {
        ...
        txtIDoffice = new javax.swing.JTextField();
        txtNameOffice = new javax.swing.JTextField();
        ...
        txtIDoffice1 = new javax.swing.JTextField();
        txtNameOffice1 = new javax.swing.JTextField();
        ...
        jLabel1.setText("ID office:");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 60, -1, -1));

        jLabel2.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Name office:");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, -1, -1));

        txtIDoffice.setBackground(new java.awt.Color(51, 51, 51));
        txtIDoffice.setForeground(new java.awt.Color(255, 255, 255));
        txtIDoffice.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtIDofficeActionPerformed(evt);
            }
        });
        jPanel1.add(txtIDoffice, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 70, 110, -1));

        txtNameOffice.setBackground(new java.awt.Color(51, 51, 51));
        txtNameOffice.setForeground(new java.awt.Color(255, 255, 255));
        jPanel1.add(txtNameOffice, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 140, 110, -1));
        ...
        jLabel3.setText("ID office:");
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 60, -1, -1));

        jLabel4.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Name office:");
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, -1, -1));

        txtIDoffice1.setBackground(new java.awt.Color(51, 51, 51));
        txtIDoffice1.setForeground(new java.awt.Color(255, 255, 255));
        txtIDoffice1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtIDoffice1ActionPerformed(evt);
            }
        });
        jPanel2.add(txtIDoffice1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 70, 110, -1));

        txtNameOffice1.setBackground(new java.awt.Color(51, 51, 51));
        txtNameOffice1.setForeground(new java.awt.Color(255, 255, 255));
        jPanel2.add(txtNameOffice1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 140, 110, -1));
    ...
    private void txtIDofficeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtIDofficeActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtIDofficeActionPerformed

    private void txtIDoffice1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtIDoffice1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtIDoffice1ActionPerformed
    ...
    private javax.swing.JTextField txtIDoffice;
    private javax.swing.JTextField txtIDoffice1;
    private javax.swing.JTextField txtNameOffice;
    private javax.swing.JTextField txtNameOffice1;
